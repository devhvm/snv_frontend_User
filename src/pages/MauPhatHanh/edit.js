...
//     data.location.state.maMauPhatHanh ? data.location.state.maMauPhatHanh : ''
//   )
//   const [tenMauPhatHanh, setTenMauPhatHanh] = useState(
//     data.location.state.tenMauPhatHanh ? data.location.state.tenMauPhatHanh : ''
//   )
//   const [ngayPhatHanh, setNgayPhatHanh] = useState(
//     data.location.state.ngayPhatHanh ? data.location.state.ngayPhatHanh : ''
//   )
//   const [trangThai, setTrangThai] = useState(
//     data.location.state.trangThai ? data.location.state.trangThai : ''
//   )
//
//   return (
//     <Fragment>
